        ...
        if(empty($key) || $key==0):
         ...
         $certificate_value=0;
            ...
            foreach($availableCode as $code){
                ...
                /*$result=array(0=>$certificate_value,1=>'Gift Certificate Accepted');
                ...
                return $result_return;*/  
                    ...
                    $gift_value = intval($cart_subtotal);

                    if($certificate_value < intval($cart_subtotal)) {
                    ...
                    if ($code->getDiscountType() == "percent") {
                        ...
                        if($gift_value > intval($cart_subtotal)){
                            $gift_value = intval($cart_subtotal);
                        ...
                        /*if($gift_value > $code->getCurrentBalance()){
                        ...
                        $formula = $sub_total/100*$code['current_balance'];
