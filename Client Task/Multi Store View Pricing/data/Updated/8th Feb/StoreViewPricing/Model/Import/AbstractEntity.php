...
abstract class AbstractEntity
{
     ...
     */
    // @codingStandardsIgnoreLine
    public $_specialAttributes = [self::COLUMN_ACTION];
     ...
     */
    // @codingStandardsIgnoreLine
    public $_processedEntitiesCount = 0;
     ...
     * @return boolean
     */
    abstract public function _importData();
     ...
     * @return void
     */
    public function addErrors($code, $errors)
    {
        if ($errors) {
     ...
     * @return $this
     */
    public function updateItemsCounterStats(array $created = [], array $updated = [], array $deleted = [])
    {
