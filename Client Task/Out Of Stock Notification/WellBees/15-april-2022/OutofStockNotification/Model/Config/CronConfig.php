...
namespace Mageants\OutofStockNotification\Model\Config;

class CronConfig extends \Magento\Framework\App\Config\Value
{
    const CRON_STRING_PATH = 'crontab/outofstock_cron_alert/jobs/send_notify_product_alert/schedule/cron_expr';

    const CRON_MODEL_PATH = 'crontab/outofstock_cron_alert/jobs/send_notify_product_alert/run/model';
