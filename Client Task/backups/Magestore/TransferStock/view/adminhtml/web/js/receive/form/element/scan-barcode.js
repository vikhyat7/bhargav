...
define([
    ...
    return Element.extend({
        defaults: {
            ...
            valueUpdate: false,
            focused: false,
            template: 'Magestore_TransferStock/receive/form/element/barcode-input',
            barcodeJson: null,
            sourceElment: '',
            destinationElement: '',
            selectionsProvider: '',
        ...
        insertParams: function(data) {
            this.barcodeJsonParams = {
                'transfer_id': data.inventorytransfer_id,
        ...
        getBarcodeJson: function () {
            ...
            if(typeof this.barcodeJsonParams.transfer_id !== 'undefined' && this.barcodeJsonParams.transfer_id !== null) {
                url = url + 'transfer_id/' + this.barcodeJsonParams.transfer_id + '/';
            }
            if(typeof this.barcodeJsonParams.source_warehouse_code !== 'undefined' && this.barcodeJsonParams.source_warehouse_code !== null) {
                url = url + 'source_warehouse_code/' + this.barcodeJsonParams.source_warehouse_code;
            }
            this.loading(true);
        ...
        onUpdate: function () {
            ...
            if (this.value() != '') {
                if (this.barcodeJson && typeof this.barcodeJson[this.value()] != 'undefined') {
                    ...
                    var successMessage = $t('Barcode #%s has been added to the list.').replace('%s', this.value());
        ...
        updateInputValue: function (des, map, indexField, gridData, index) {
            ...
            if (qtyElement) {
                ...
                if (element) {
                    ...
                    value = isNaN(value) ? 0 : value;
                    // des.relatedData[index][this.inputElementName] = value;
                    des.recordData.valueHasMutated();
                }
                result.resolve();
            }
