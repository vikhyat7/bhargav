...
define([
    ...
    $.widget('mage.barcodeProducts', {
        /**
         * Create widget
         * @private
         */
        _create: function () {
            this.$grid = this.element.find('[data-role=barcode-product-grid]');
            this.$grid.sortable({
                distance: 8,
                items: '[data-role=row]',
                tolerance: 'pointer',
            ...
            this.productTmpl = mageTemplate('#barcode-product-template');
            if(this.$grid.data('products')){
