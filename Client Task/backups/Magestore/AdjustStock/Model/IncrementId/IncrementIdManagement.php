 ...
 */
namespace Magestore\AdjustStock\Model\IncrementId;

use Magestore\AdjustStock\Api\IncrementIdManagementInterface;
...
class IncrementIdManagement implements IncrementIdManagementInterface
{
    ...
    /**
     *
     * @var \Magestore\AdjustStock\Model\IncrementId\IncrementIdFactory
     */
    protected $_incrementIdFactory;

    public function __construct(
        \Magestore\AdjustStock\Model\IncrementId\IncrementIdFactory $incrementIdFactory
    )
    {
    ...
    {
        /** @var \Magestore\AdjustStock\Model\IncrementId\IncrementId $model */
