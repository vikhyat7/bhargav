...
namespace Magestore\FulfilReport\Block\Adminhtml\Report\Fulfilwarehousedaily;
...
class Grid extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    /**
     * @var \Magestore\FulfilReport\Model\ResourceModel\PickRequest\FulfilWarehouseDaily\CollectionFactory
     */
    protected $pickRequestCollectionFactory;

    /**
     * @var \Magestore\FulfilReport\Model\ResourceModel\PackRequest\FulfilWarehouseDaily\CollectionFactory
     */
     ...
     * @param \Magestore\FulfilReport\Model\ResourceModel\PickRequest\FulfilWarehouseDaily\CollectionFactory $pickRequestCollectionFactory
     * @param \Magestore\FulfilReport\Model\ResourceModel\PackRequest\FulfilWarehouseDaily\CollectionFactory $packRequestCollectionFactory
    ...
    public function __construct(
        ...
        \Magestore\FulfilReport\Model\ResourceModel\PickRequest\FulfilWarehouseDaily\CollectionFactory $pickRequestCollectionFactory,
        \Magestore\FulfilReport\Model\ResourceModel\PackRequest\FulfilWarehouseDaily\CollectionFactory $packRequestCollectionFactory,
    ...
    protected function _prepareCollection()
    {
        ...
        foreach ($pickRequestsCollection as $pickRequest) {
            $resultArray[$pickRequest->getDate() . "_" . $pickRequest->getResourceFieldId()]['warehouse'] = $pickRequest->getResourceFieldName();
            $resultArray[$pickRequest->getDate() . "_" . $pickRequest->getResourceFieldId()]['date'] = $pickRequest->getDate();
            $resultArray[$pickRequest->getDate() . "_" . $pickRequest->getResourceFieldId()]['pick'] = $pickRequest->getData('total_picked_requests');
        }
        /** @var \Magestore\FulfilSuccess\Api\Data\PackRequestInterface $packRequest */
        foreach ($packRequestsCollection as $packRequest) {
            $resultArray[$packRequest->getDate() . "_" . $packRequest->getResourceFieldId()]['warehouse'] = $packRequest->getResourceFieldName();
            $resultArray[$packRequest->getDate() . "_" . $packRequest->getResourceFieldId()]['date'] = $packRequest->getDate();
            $resultArray[$packRequest->getDate() . "_" . $packRequest->getResourceFieldId()]['pack'] = $packRequest->getData('total_packed_requests');
        }
        foreach ($resultArray as $warehouseData) {
            $item = new DataObject();
            $item->setDate($warehouseData['date']);
    ...
    {
        /** @var \Magestore\FulfilReport\Model\ResourceModel\PickRequest\FulfilWarehouseDaily\Collection $collection */
    ...
    {
        /** @var \Magestore\FulfilReport\Model\ResourceModel\PackRequest\FulfilWarehouseDaily\Collection $collection */
