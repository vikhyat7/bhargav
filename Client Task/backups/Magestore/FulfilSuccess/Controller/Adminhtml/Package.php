...
abstract class Package extends \Magento\Backend\App\Action
{
    /**
    ...
    {
        $resultPage->setActiveMenu('Magestore_FulfilSuccess::package')
            ->addBreadcrumb(__('Fulfillment Success'), __('Fulfillment Success'))
            ->addBreadcrumb(__('Packages'), __('Packages'));
        return $resultPage;
    }
}
