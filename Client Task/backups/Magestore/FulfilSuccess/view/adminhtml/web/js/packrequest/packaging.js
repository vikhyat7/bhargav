...
define([
    ...
    "uiRegistry",
    "prototype"
], function($D, PackRequestItem, fullScreenLoader, registry){
    ...
    Packaging.prototype = {
        ...
        /**
         * Reload list recent packed requests
         */
...
//******************** End Setters *******************************//
        ...
        showWindow: function(callBackUrl) {
            // if(callBackUrl) {
...
//******************** Private functions **********************************//
        ...
        _setAllItemsPackedState: function() {
            var addPackageBtns = $$('[data-action=add-packages]');
            var addPackageBtn = addPackageBtns.last();
            var savePackagesBtns = $$('[data-action=save-packages]');
            var savePackagesBtn = savePackagesBtns.last();
