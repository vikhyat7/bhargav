...
class PrintItems extends \Magestore\FulfilSuccess\Ui\Component\Listing\Columns\Actions
{
    protected $_editUrl = 'fulfilsuccess/pickRequest/printOrderItems';
    
    /**
     * @var string
     */
    protected $actionLabel = 'Print';    
