...
namespace Magestore\PurchaseOrderSuccess\Model\ResourceModel\PurchaseOrder\Item\Returned\Select\Grid;
...
/**
 * Class Collection
 * @package Magestore\PurchaseOrderSuccess\Model\ResourceModel\PurchaseOrder\Item\Returned\Select\Grid
 */
        ...
        $this->getSelect()->from(['main_table' => $this->getMainTable()])
            ->columns([
                'available_qty' => new \Zend_Db_Expr(
                    'main_table.qty_received - main_table.qty_returned - main_table.qty_transferred'
                )
            ])
