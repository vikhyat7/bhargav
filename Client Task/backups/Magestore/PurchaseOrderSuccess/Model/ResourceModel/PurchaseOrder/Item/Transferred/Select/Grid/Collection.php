...
namespace Magestore\PurchaseOrderSuccess\Model\ResourceModel\PurchaseOrder\Item\Transferred\Select\Grid;
        ...
        $this->getSelect()->from(['main_table' => $this->getMainTable()])
            ->columns([
                'available_qty' => new \Zend_Db_Expr(
                    'main_table.qty_received - main_table.qty_transferred - main_table.qty_returned' 
                )
            ])
