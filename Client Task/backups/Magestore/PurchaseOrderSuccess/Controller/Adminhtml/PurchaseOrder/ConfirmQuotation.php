 ...
 */
class ConfirmQuotation extends \Magestore\PurchaseOrderSuccess\Controller\Adminhtml\AbstractAction
{
    /**
     * Authorization level of a basic admin session
     */
    const ADMIN_RESOURCE = 'Magestore_PurchaseOrderSuccess::confirm_quotation';
    ...
    public function execute()
    {
        ...
        if($this->purchaseOrderRepository->confirmQuotation($purchaseId)){
            ...
            return $this->redirectForm($type, $purchaseId, __('Quotation has been confirmed'));
        }else{
            return $this->redirectForm(
                $type,
                $purchaseId, __('Can not confirm Quotation'),
                'error',
