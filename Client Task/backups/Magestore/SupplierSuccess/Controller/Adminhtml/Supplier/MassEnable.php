 ...
 * Class MassDelete
 */
class MassEnable extends AbstractSupplier
{
    ...
    public function execute()
    {
        ...
        foreach ($collection as $supplier) {
            $supplier->setStatus(\Magestore\SupplierSuccess\Service\SupplierService::STATUS_ENABLE);
            $supplier->save();
        }

        $this->messageManager->addSuccessMessage(__('%1 record(s) have been enabled.', $collectionSize));
