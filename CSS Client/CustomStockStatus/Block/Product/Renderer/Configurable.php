...
class Configurable extends \Magento\Swatches\Block\Product\Renderer\Configurable
{
    ...
    public function getSimpleProductId()
    {
        ...
        foreach ($_configChild as $key => $child) {
            // $productStock = $objectManager->get('Magento\CatalogInventory\Api\StockRegistryInterface');
            // $productLoad = $productStock->getStockItem($child);
            $productStock = $this->objectManager->get('Magento\CatalogInventory\Api\StockRegistryInterface');
            $productLoad = $productStock->getStockItem($child);
