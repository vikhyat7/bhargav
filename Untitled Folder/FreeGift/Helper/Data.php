...
class Data extends \Magento\Framework\App\Helper\AbstractHelper
{
  ...
  {   
    ...
    public function getCartBasedValidRuleOnAddtoCart()
    {
        ...
        // $this->logger->info(print_r('subtotal: '.$subtotal,true));
        // $this->logger->info(print_r('subtotalExcl: '.$subtotalExcl,true));
        // $this->logger->info(print_r('subtotal_include_Tax: '.$subtotal_include_Tax,true));
