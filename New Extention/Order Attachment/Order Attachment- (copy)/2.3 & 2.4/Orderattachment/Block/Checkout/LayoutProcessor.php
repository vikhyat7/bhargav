    ...
    public function process($jsLayout)
    {
     ...
     protected function addToAfterPaymentMethods(&$jsLayout)
     {
        if (isset($jsLayout['components']['checkout']['children']['steps']['children']['billing-step']
            ...
            $fields['order-attachment-after-payment-methods'] = ['component' => "Mageants_Orderattachment/js/view/order/payment/payment-attachment"];
        }
           ...
           if (isset($jsLayout['components']['checkout']['children']['steps']['children']['shipping-step']
                ...
                $fields['order-attachment-after-shipment-methods'] =
                    [
                        ...
                        'children' =>  ['attachment'=> ['component' => "Mageants_Orderattachment/js/view/order/shipment/shipment-attachment"]]
                    ];
          }
