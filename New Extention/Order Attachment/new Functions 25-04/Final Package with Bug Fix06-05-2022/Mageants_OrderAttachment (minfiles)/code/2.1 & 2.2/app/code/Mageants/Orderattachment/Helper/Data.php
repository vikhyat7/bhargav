...
class Data extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    {
        // $storeScope = \Magento\Store\Model\ScopeInterface::SCOPE_STORE;
        // return $this->scopeConfig->getValue(self::XML_PATH_ADMIN_EMAIL, $storeScope);

       return $this->scopeConfig->getValue(
                \Mageants\Orderattachment\Model\Attachment::XML_PATH_ADMIN_EMAIL,
                \Magento\Store\Model\ScopeInterface::SCOPE_STORE
            );
    }
    ...
    public function getAttachmentConfig($block)
    {
        ...
        $config = [
            ...
            'isCustomerAllow' => $this->scopeConfig->getValue(
                \Mageants\Orderattachment\Model\Attachment::XML_PATH_FRONTEND_ENABLED,
                \Magento\Store\Model\ScopeInterface::SCOPE_STORE
            ),
