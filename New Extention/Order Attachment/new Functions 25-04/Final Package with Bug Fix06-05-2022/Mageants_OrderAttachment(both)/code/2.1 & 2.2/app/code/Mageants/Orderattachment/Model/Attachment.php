...
class Attachment extends AbstractModel implements AttachmentInt, IdentityInterface
{
    ...
    const XML_PATH_FRONTEND_ENABLED = 'orderattachments/frontend_demo/Fenabled';
    
    const XML_PATH_ADMIN_EMAIL = 'orderattachments/frontend_demo/admin_email';
    ...
    {
        $this->_init('Mageants\Orderattachment\Model\ResourceModel\Attachment');
    }
